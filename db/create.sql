...
insert into products (name, description, code, price, merk_id, gebruik_id) values ('Sony a7c','Leg het leven vast zoals je het ziet met de Alpha 7C systeemcamera van Sony. Deze veelzijdige systeemcamera beschikt over een 24.2 megapixel Exmor R CMOS-sensor en heeft een ISO-bereik van 100-51200 waardoor het mogelijk wordt om in alle lichtsituaties gedetailleerde foto's en video's te maken.', '589023', 2399, 1, 2);
